...
def ETL(x):
  ...
  clima = {'Frío_seco': ' Frio_secoFrio_húmedo',
           ' Frio_humedoCálido_húmedo': ' Calido_humedoTemplado_húmedo',
           ' Templado_humedoCálido_muy húmedo': ' Calido_muy_humedoMuy frío_muy húmedo',
           ' Muy_frio_muy_humedoFrío_húmedo y muy húmedo': ' Frio_muy_humedoMuy frío_húmedo y muy húmedo',
           ' Muy_frio_muy_humedoMuy frío_seco': ' Muy_frio_secoExtremadamente frío_húmedo',
           ' Extremadamente_frio_humedoCálido_seco': ' Calido_secoExtremadamente frío_húmedo y muy húmedo',
           ' Extremadamente_frio_muy_humedoFrío_muy húmedo': ' Frio_muy_humedoExtremadamente frío_húmedo_muy húmedo y pluvial',
           ' Extremadamente_frio_muy_humedo_pluvialTemplado_húmedo y muy húmedo': ' Templado_muy_humedoCálido_húmedo y muy húmedo',
           ' Calido_muy_humedoMuy frío y muy húmedo': ' Muy frio_muy_humedoFrío_pluvial',
           ' Frio_pluvialTemplado_pluvial': ' Templado_pluvialMuy frío_húmedo',
           ' Muy_frio_humedoTemplado_muy húmedo': ' Templado_muy_humedo'}
  ...
  # PROFUNDIDAD_MAXIMA
  x_df["PROFUNDIDAD_MAXIMA"] = x_df["PROFUNDIDAD MAXIMA"].astype(float)

  # CONTENIDO_CENIZA_VOLCANICA
  x_df["CONTENIDO_CENIZA_VOLCANICA"] = df['MATERIAL_PARENTAL_LITOLOGIA'].str.lower().str.contains('volc')
  ...
  for i in x_df.select_dtypes("object").columns:
    x_df[i] = x_df[i].astype("category")
  for i in x_df.select_dtypes("category").columns:
